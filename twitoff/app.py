...
def  create_app():
    ...
    #innistialized our DB with sqlalchemy application
    DB.init_app(app)




    @app.route('/') #decorator able to edit a function without making an overriding change 
    def root():
        users = Users.query.all() #pulls all users from user tables
